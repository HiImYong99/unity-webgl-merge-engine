...
public class BridgeMgr : MonoBehaviour
{
    ...
    [DllImport("__Internal")] private static extern void showGameOverFromUnity(int score, int best);
    ...
    public void ShowGameOver(int s, int b) => showGameOverFromUnity(s, b);
    ...
    // ── IAP Public API ──────────────────────────────────────────────
    public void RequestIAPPurchase(string productId) => RequestPurchase(productId);
    public void RequestRestorePurchases() => RestorePurchases();
    ...
    // payload 형식: "productId|purchaseToken"
    public void OnRestorePurchasesRequested(string _) => RestorePurchases();
