...
public class AnimalPopSetup : EditorWindow
{
    ...
    private static void CreateCoreManagers()
    {
        ...
        new GameObject("IAPManager").AddComponent<IAPMgr>();
    ...
    private static void CreateAndroidUI()
    {
        ...
        Text titleText = MakeText(landingPanel.transform, "TitleText", "Animal Pop",
        ...
        Button soundBtn = MakeButton(hudPanel.transform, "SoundButton",
            "Sound", new Color(0.9f, 0.88f, 1f, 0.75f), new Color(0.25f, 0.15f, 0.4f), 36);
        ...
        // GameOverScoreText는 WebGL에서 HTML 오버레이가 처리하므로 할당 불필요
